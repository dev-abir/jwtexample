...
Now, extract and import the gradle/maven project into your preferred editor. If any error occurs, make sure about *
...
![Register response](imgs/4_register_response.png)

![Login response](imgs/5_login_response.png)

![Set access token](imgs/6_set_access_token.png)

![Profile](imgs/7_profile.png)

![H2 login](imgs/8_h2_login.png)
